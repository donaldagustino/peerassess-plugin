...
$current_tab = 'showgraphicanalysis';
...
$baseurl = new moodle_url('/mod/peerassess/show_graphical_analysis.php', array('id' => $cm->id));
...
$breakdownbaseurl = new moodle_url('/mod/peerassess/show_graphical_analysis.php');
